...
class _ChecklistPageState extends State<ChecklistPage> {
  ...
  void addItem() async {
    ...
    final childSelectionCubit = context.read<ChildSelectionCubit>();
    final childState = childSelectionCubit.state;
    
    if (userId == null || childState is! ChildSelected) return;
    ...
    context.read<ChecklistCubit>().addItem(newItem);
